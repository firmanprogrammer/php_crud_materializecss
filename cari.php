      ...
      <div class="row section">
        ...
        <div class="col s12 m12 l12">
          ...
          <ul class="pagination center-align card section">
            <li class="waves-effect"><a href="cari.php?page=1<?php echo $cari; ?>"><i class="material-icons">fast_rewind</i></a></li>
              <?php
                  if ($pagenow>3) {
                    $pagenow = $pagenow-3;
                  }else if ($pagenow>2) {
                  ...
                  for ($i=$pagenow; $i<=$pageLast; $i++){
                     if (!isset($_GET["page"]) && $i==1) {
                         ...
                         echo '<li class="waves-effect"><a href="cari.php?page='.$i.$cari.'">'.$i.'</a></li>';
                     }
                  }
              ...
              ?>
            <li class="waves-effect"><a href="cari.php?page=<?php echo $total_pages.$cari;?>" ><i class="material-icons">fast_forward</i></a></li>
          </ul>
